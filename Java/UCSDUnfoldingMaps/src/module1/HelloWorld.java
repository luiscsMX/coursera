...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(100, 100, 100, alpha(75));
		
		// Map provider for map1
		AbstractMapProvider provider1 = new Google.GoogleMapProvider();

        // Map provider for map2
        ...
        // The next line zooms in and centers the map at
        // 32.9 (latitude) and -117.2 (longitude)
        map2.zoomAndPanTo(zoomLevel, new Location(38.2400573f, -85.7371953f));
